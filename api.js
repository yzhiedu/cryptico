...
var cryptico = (function() {
	...
	/**
	 * we are able to encrypt strings:
	 *
	 * var publicKey = "{$n}|{$e}";
	 ...
	 * my.encrypt
	 * description: 
	 * The result of cryptico.encrypt is NOT simply encrypted by RSA. indeed, it was combined of two parts: 
	 * an aes key encrypted by RSA, and the cipher of the plain text encrypted with that aes key by AES. 
	 * if we only need RSA, we could modify it.
	 */
